...
class Preferences(AddonPreferences):  # setting up perferences
    ...
    def draw(self, context):
        layout = self.layout
        layout.label(
            text="A subfolder in the same directory as the blend file will be used to save the images.")
        layout.label(
            text="Unless the file is unsaved or 'Always Use Secondary Directory' is checked.")
        layout.label(
            text="In which case, the Secondary Directory will be used")
