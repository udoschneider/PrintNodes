...
class ContextMenu(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("prtnd.modal_ss_timer",
                        text="Take Screenshot Of Whole Tree", icon="NODETREE")
        layout.operator("prtnd.modal_ss_timer", text="Take Screenshot Of Selected Nodes",
                        icon="SELECT_SET").selection_only = True
